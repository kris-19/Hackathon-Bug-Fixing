...
contract Marriage {
    ...
    function wedding(address _groom, address _bride) public payable returns(uint256) {
        ...
        require(isUserMarried[_groom] == false || isUserMarried[_bride] == false);
        ...
        LogJustMarried(_groom,_bride,_registry,now);
     ...
     */
    function divorced(uint256 _registry) onlyLawyer public {
